...
import ClientVouvoiementGuard from "@/components/ClientVouvoiementGuard";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="fr">
      <body suppressHydrationWarning className={`${playfair.variable} ${ebGaramond.variable} ${cinzel.variable}`}>
        <ClientVouvoiementGuard />
