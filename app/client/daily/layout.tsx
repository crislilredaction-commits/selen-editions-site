...
export default function DailyClientLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <nav aria-label="Navigation Selen Daily" style={{display:"flex",justifyContent:"center",gap:".55rem",flexWrap:"wrap",padding:".75rem 1rem",borderBottom:"1px solid var(--sepia-mid)",background:"var(--paper)"}}>
