...
const s: Record<string, React.CSSProperties> = {
  ...
  form: { maxWidth: 760, margin: "1rem auto 3rem", display: "grid", gap: "1rem", background: "var(--paper)", border: "1px solid var(--sepia-mid)", padding: "clamp(1rem, 4vw, 1.5rem)", boxSizing: "border-box" },
  identity: { display: "grid", gap: "0.2rem", paddingBottom: "0.75rem", borderBottom: "1px solid rgba(178,138,98,0.28)", minWidth: 0, overflowWrap: "anywhere" },
  fieldset: { border: "1px solid var(--sepia-mid)", padding: "0.85rem", display: "flex", flexWrap: "wrap", gap: "1rem", minWidth: 0, boxSizing: "border-box" },
  legend: { fontWeight: 800, padding: "0 0.35rem" },
  choice: { display: "flex", gap: "0.45rem", alignItems: "center" },
  label: { display: "grid", gap: "0.4rem", fontWeight: 800, minWidth: 0 },
  input: { width: "100%", boxSizing: "border-box", minWidth: 0, padding: "0.8rem", border: "1px solid var(--sepia-mid)", background: "white", font: "inherit" },
  textarea: { width: "100%", boxSizing: "border-box", minWidth: 0, padding: "0.8rem", border: "1px solid var(--sepia-mid)", background: "white", font: "inherit", resize: "vertical" },
  help: { margin: 0, color: "var(--ink-soft)", lineHeight: 1.5, fontSize: "0.92rem" },
  button: { border: 0, padding: "0.9rem 1rem", background: "var(--rust)", color: "white", fontWeight: 800, cursor: "pointer", width: "100%", boxSizing: "border-box" },
  success: { maxWidth: 760, margin: "1rem auto 3rem", display: "grid", gap: "0.7rem", background: "var(--paper)", border: "1px solid var(--sepia-mid)", borderLeft: "4px solid var(--ocre-gold)", padding: "1rem", boxSizing: "border-box", overflowWrap: "anywhere" },
};
