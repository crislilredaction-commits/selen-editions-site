...
export default function PrepaNdaPage() {
  return (
    <main className="gazette-paper min-h-screen text-[#3e2a1f]">
      ...
      <section className="relative overflow-hidden px-4 md:px-6 pt-16 md:pt-24 pb-12 md:pb-16">
        <div className="mx-auto max-w-5xl text-center">
          <p className="gazette-label">Prépa NDA</p>

          <h1 className="mt-4 font-['Playfair_Display'] text-4xl md:text-6xl font-bold leading-tight">
            Obtenir votre numéro de déclaration d’activité sans vous perdre dans
            l’administratif
          </h1>
      ...
      <section className="mx-auto max-w-5xl px-4 md:px-6 pb-16 md:pb-20">
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <article className="gazette-card p-6">
            ...
            <p className="mt-4 leading-7 text-[#5a4031]">
              Votre dossier est suivi dans votre espace client, avec échanges
              via la messagerie Selen et accompagnement en cas de retour DREETS.
            </p>
          </article>
        </div>

        <div className="mt-8 gazette-card p-6 md:p-8">
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-start">
            ...
            <aside className="border border-[#b28a62]/30 bg-[#f8efdf]/70 p-6 text-center">
              ...
              <p className="mt-4 leading-7 text-[#5a4031]">
                Paiement sécurisé. Après validation, votre espace client et
                votre dossier Prépa NDA sont créés automatiquement.
              </p>
        ...
        <div className="mt-8 gazette-card p-6 md:p-8">
          ...
          <p className="mt-4 max-w-3xl leading-8 text-[#5a4031]">
            ...
            espace client Selen vous guide jusqu’au dépôt, puis vous aide à
            suivre la réponse de la DREETS.
          </p>
        </div>
      </section>
